...
\titlePL{Budowa aplikacji www wspierającej tryb off-line przy użyciu HTML5}
\titleEN{Building offline enabled web application with HTML5}

\shorttitlePL{Budowa aplikacji www wspierającej tryb off-line przy użyciu HTML5} % skrócona wersja tytułu jeśli jest bardzo długi
